...
public class NewsAction extends ActionSupport {
	...
	// URL地址：http://localhost:8080/SSHHibernateDaoSupportProject/pages/news/NewsAction!insert.action?news.title=世界，你好&news.content=今天天气很好
	public void insert() {
	...
	// URL地址：http://localhost:8080/SSHHibernateDaoSupportProject/pages/news/NewsAction!update.action?news.title=世界，你好&news.content=今天天气很好&news.nid=8
	public void update() {
	...
	// URL地址：http://localhost:8080/SSHHibernateDaoSupportProject/pages/news/NewsAction!delete.action?ids=12|13
	public void delete() {
	...
	// URL地址：http://localhost:8080/SSHHibernateDaoSupportProject/pages/news/NewsAction!get.action?news.nid=16
	public void get() {
	...
	// URL地址：http://localhost:8080/SSHHibernateDaoSupportProject/pages/news/NewsAction!list.action
	public void list() {
	...
	// URL地址：http://localhost:8080/SSHHibernateDaoSupportProject/pages/news/NewsAction!listSplit.action
